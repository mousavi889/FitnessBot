...
public class Q1State implements BotState
{

    private long chatId;
    MainController mainController;
    public Q1State(MainController mainController, long chatId)
    {
        this.chatId = chatId;
    ...
    {
        if(update.getMessage().getText().equals("عضویت"))
        {
            String message = "جنسیت خود را انتخاب کنید.";
            String keyboardMessage = "مرد,زن";
            this.changeState("q1");
