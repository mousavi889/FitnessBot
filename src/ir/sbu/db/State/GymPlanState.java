package ir.sbu.db.State;
        ...
        import ir.sbu.db.Model.GymPlan;
...
public class GymPlanState implements BotState
{

    private long chatId;
    MainController mainController;
    public GymPlanState(MainController mainController, long chatId)
    {
        this.chatId = chatId;
    ...
    public void validate(Update update)
    {
        if(update.getMessage().getText().length()<25)
        {
            ...
            String plan1 = gymPlan.getPlan1(chatId);
            String plan2 = gymPlan.getPlan2(chatId);
            String plan3 = gymPlan.getPlan3(chatId);
            String message = plan1 + "\n\n" + plan2 + "\n\n" + plan3;
            String keyboardMessage = "اوکی";
            this.changeState("gymPlan");
